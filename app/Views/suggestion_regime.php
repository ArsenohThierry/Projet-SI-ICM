...
<div class="regime-body">
    <div class="regime-wrapper anim-fade-up">
        ...
        <?php
            ...
            $defaultIcons = [
                'fa-leaf', 'fa-apple-whole', 'fa-carrot', 'fa-egg',
                'fa-cheese', 'fa-drumstick-bite', 'fa-utensils'
            ];
                ...
                <div class="regime-card"
                    ...
                    <div class="regime-stats">
                        ...
                        <div class="regime-stat" style="color: var(--primary); font-weight: 600;">
                            ...
                            <span class="regime-stat-value"><?php echo ($variation > 0 ? '+' : '') . number_format($variation, 1); ?> kg/mois</span>
                        </div>
                    </div>
        ...
        <form method="post" action="/regime" id="regime-form">
            ...
            <!-- Date de début -->
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 1.25rem 1.5rem; margin-top: 1rem;">
                <label for="date_debut" style="display: block; margin-bottom: 0.75rem; font-weight: 600; color: var(--text-primary);">
