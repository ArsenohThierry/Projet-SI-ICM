...
<head>
    ...
    <style>
        ...
        .imc-category-item.active-info {
            border-color: #3B82F6;
            background: var(--info-light);
            color: #3B82F6;
        }

        .imc-category-item.active-green {
            border-color: var(--primary);
            background: var(--primary-light);
            color: var(--primary-dark);
        }

        .imc-category-item.active-gold {
            border-color: var(--gold);
            background: var(--gold-light);
            color: var(--gold-dark);
        }

        .imc-category-item.active-danger {
                        ...
                        <?php if ($hasResult): ?>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3><i class="fa-solid fa-weight-scale"
                                            style="color:var(--primary); margin-right:8px;"></i>Resultat de votre IMC</h3>
                                ...
                                <div class="card-body" style="display:flex; flex-direction:column; gap:1.5rem;">
                                    ...
                                    <div style="display:flex; align-items:flex-end; gap:1rem;">
                                        ...
                                        <div style="padding-bottom:0.6rem;">
                                            <div
                                                style="font-family:'Sora',sans-serif; font-weight:700; font-size:0.85rem; color:var(--text-secondary);">
                                                kg/m²</div>
                                            <div style="font-size:0.78rem; color:var(--text-muted);">Indice de Masse
                                                Corporelle</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="imc-scale">
                                        <div class="imc-scale-bar">
                                            <div class="imc-scale-cursor" style="left: <?php echo $cursorPercent; ?>%;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="imc-categories">
                                        <div class="imc-category-item <?php echo ($imc < 18.5) ? 'active-info' : ''; ?>">
                                            Maigreur
                                            <span class="cat-range">
                                                < 18.5</span>
                                        </div>
                                        <div
                                            class="imc-category-item <?php echo ($imc >= 18.5 && $imc < 25) ? 'active-green' : ''; ?>">
                                            Normal
                                            <span class="cat-range">18.5 – 24.9</span>
                                        </div>
                                        <div
                                            class="imc-category-item <?php echo ($imc >= 25 && $imc < 30) ? 'active-gold' : ''; ?>">
                                            Surpoids
                                ...
                                <a href="/objectif" class="btn btn-primary btn-block btn-lg" style="margin-top:0.5rem;">
                                    <i class="fa-solid fa-bullseye"></i> Définir Mon Objectif
                                </a>
                                ...
                                <div class="card-footer" style="display:flex; align-items:center; gap:10px;">
                                    ...
                                    <span
                                        style="font-size:0.85rem; color:var(--text-secondary);"><?php echo $conseil; ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
